...
@section('content')
    ...
    <ol class="breadcrumb">
        <li>Edit Book Category</li>
        <li class="breadcrumb-item">
            <a href="{{ config('app.adminurl') }}">Dashboard</a> / Category / Editcategory
        </li>
    </ol>

    <div class="card card-form mx-auto mt-12 col-sm-6">
        <div class="card-body">
            <form method="POST" action="{{config('app.adminurl')}}updatecategory/{{$category->id}}">
                {!! csrf_field() !!}
                <div class="form-group ">
                    <div class="form-label-group">
                        <input type="text" id="name" class="form-control" placeholder="Category Name" name="name" required value="{{ $category->name }}">
                ...
                <div class="form-group ">
                    <div class="form-label-group">
                        ...
                        <label class="stylish-radio">
                            &nbsp;&nbsp; No &nbsp;
                            <input type="radio" name="publish" value="0" @if($category->publish == 0) checked @endif>
                            <span class="checkmark"></span>
                        </label>     
                    </div>
                </div>
                ...
                <a href="{{config('app.adminurl')}}categorylist" class="btn btn-primary">Cancel</a>
