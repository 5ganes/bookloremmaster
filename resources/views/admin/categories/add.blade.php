...
@section('content')
    ...
    <ol class="breadcrumb">
        <li>Add Book Category</li>
        <li class="breadcrumb-item">
            <a href="{{ config('app.adminurl') }}">Dashboard</a> / Category / Categoryadd
        </li>
    </ol>

    <div class="card card-form mx-auto mt-12 col-sm-6">
        <div class="card-body">
            <form method="POST" action="{{config('app.adminurl')}}storecategory">
                {!! csrf_field() !!}
                <div class="form-group ">
                    <div class="form-label-group">
                        <input type="text" id="name" class="form-control" placeholder="Category Name" name="name" required value="{{ old('name') }}">
