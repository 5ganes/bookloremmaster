...
@section('content')
    ...
    <ol class="breadcrumb">
        <li>Edit Book Publisher</li>
        <li class="breadcrumb-item">
            <a href="{{ config('app.adminurl') }}">Dashboard</a> / Publisher / Editpublisher
        </li>
    </ol>

    <div class="card card-form mx-auto mt-12 col-sm-6">
        <div class="card-body">
            <form method="POST" action="{{config('app.adminurl')}}updatepublisher/{{$publisher->id}}">
                {!! csrf_field() !!}
                <div class="form-group ">
                    <div class="form-label-group">
                        <input type="text" id="name" class="form-control" placeholder="Publisher Name" name="name" required value="{{ $publisher->name }}">
                ...
                <div class="form-group ">
                    <div class="form-label-group">
                        ...
                        <label class="stylish-radio">
                            &nbsp;&nbsp; No &nbsp;
                            <input type="radio" name="publish" value="0" @if($publisher->publish == 0) checked @endif>
                            <span class="checkmark"></span>
                        </label>     
                    </div>
                </div>
                
                <input type="submit" name="update" value="Update Publisher" class="btn btn-primary">
